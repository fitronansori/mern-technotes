...
const NewUserForm = () => {
  ...
  // Navigate to the home page if the new user was successfully added
  ...
  // If user was created, reset form and redirect to users page
  useEffect(() => {
    if (isSuccess) {
      setUsername("");
      setPassword("");
  ...
  // Event handler for the roles select element
  ...
  // Create the options for the roles select element
